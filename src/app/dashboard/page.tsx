    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        ...
        <button
          ...
          className={`p-4 rounded-2xl border text-left transition-all ${
            activeFilter === "meetings"
              ? "bg-blue-50/80 dark:bg-blue-950/40 border-blue-300 dark:border-blue-700 ring-2 ring-blue-500"
              : "bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700"
          }`}
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-zinc-500">Meetings</span>
        ...
        <button
          ...
          className={`p-4 rounded-2xl border text-left transition-all ${
            activeFilter === "follow_ups"
              ? "bg-indigo-50/80 dark:bg-indigo-950/40 border-indigo-300 dark:border-indigo-700 ring-2 ring-indigo-500"
              : "bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700"
          }`}
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-zinc-500">Follow-Ups</span>
        ...
        <button
          ...
          className={`p-4 rounded-2xl border text-left transition-all ${
            activeFilter === "overdue"
              ? "bg-rose-50/80 dark:bg-rose-950/40 border-rose-300 dark:border-rose-700 ring-2 ring-rose-500"
              : "bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700"
          }`}
        >
          <div className="flex items-center justify-between">
        ...
        <div className="p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-zinc-500">Completed</span>
      ...
      {dashboardStats.overdueActivities > 0 && activeFilter !== "overdue" && (
        <div className="p-4 rounded-2xl bg-rose-500/10 border border-rose-300 dark:border-rose-900/60 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-rose-700/80 dark:text-rose-300/80">
                Take quick action or reschedule to keep your pipeline moving.
              </p>
            </div>
          </div>
          <Button
